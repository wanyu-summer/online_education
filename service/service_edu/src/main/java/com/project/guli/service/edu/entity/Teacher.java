...
public class Teacher extends BaseEntity {
    ...
    @ApiModelProperty(value = "讲师姓名",example = "万瑜")
    private String name;

    @ApiModelProperty(value = "讲师简介",example = "自闭儿童")
    private String intro;

    @ApiModelProperty(value = "讲师资历,一句话说明讲师",example = "人间日常，浪漫宇宙")
    private String career;

    @ApiModelProperty(value = "头衔 1高级讲师 2首席讲师",example = "1")
    private Integer level;

    @ApiModelProperty(value = "讲师头像",example = "假装有头像")
